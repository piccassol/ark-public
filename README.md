...
<p align="center">
  <img src="[./assets/ark-logo.png" alt="ARK Technologies Logo](https://arktechnologies.ai/ark-logo.png)" width="400" />
</p>
...
|-----|-----------|----------|-------------|
| **ark-sdk-js** | TypeScript | [npmjs.com/package/ark-sdk-js](https://www.npmjs.com/package/ark-sdk-js) | Lightweight client for Node.js & browser apps |
| **ark-sdk-py** | Python | [pypi.org/project/ark-sdk](https://pypi.org/project/ark-sdk) | Simple async/sync client for Python apps |
...
<p align="center">
  <strong>Build, Test, and Integrate Ark Features Seamlessly</strong><br><br>
  <a href="https://arktechnologies.ai">🌐 arktechnologies.ai</a> |
  <a href="https://docs.arktechnologies.ai">📖 Docs</a> |
  <a href="https://github.com/piccassol">🐙 GitHub</a>
</p>
